...
public class EditProfileActivity extends BaseActivity {
    ...
    @Bind(R.id.BrandListcontent)
    LinearLayout brandcontent;
    @Bind(R.id.carSettingsBrand)
    TextView carbrand;
...
*/
    ...
    private void loadProfile()
    {
        ...
        controller.getProfile(userId, new GetProfileCallback()
        {
            ...
            public void success(User user)
            {
                ...
                phonenumber.setText(user.getPhonrNumber());
              ...
              //          .into(imageViewProfilePicture);
                ...
                carbrand.setText(user.getCarDetails().getYear());
    ...
    {
        UserApiController controller = new UserApiController(getApplicationContext());
        controller.getProfile(userId, new SetProfileCallback()
        {
            @Override
            public void success(User user)
            {
                ...
                user.setPhonrNumber(phonenumber.getText().toString());
